...
public class FrmDatosComprador extends javax.swing.JDialog {   
    
    private final ClienteControl CLIENTE_CONTROL;
    private Cliente cliente;

    public FrmDatosComprador(java.awt.Frame parent, FrmListadoVentas frm, int idPropietario, boolean modal) {
        super(parent, modal);
        initComponents();  
    ...
    private void mostrar(int idComprador) {        
        cliente = CLIENTE_CONTROL.selectByID(idComprador);
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DATOS COMPRADOR", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
